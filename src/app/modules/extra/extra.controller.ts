...
class ExtraController {
  ...
  public async show(req: Request, res: Response): Promise<void> {
    ...
    if (checkObjectId(extraId)) {
        ...
        .then((result) => {
          if (result === null || result === undefined) {
            const response = {
              ...
              errMsg: i18n.__("extra.extraNotFound"),
            };
      ...
      const response = {
        ...
        errMsg: i18n.__("extra.invalidExtraId"),
      };
  ...
  /**
   * Get showing extras details handler
   *
   * @author Valentin Magde <valentinmagde@gmail.com>
   * @since 2024-11-17
   *
  ...
  public async deleteMany(req: Request, res: Response): Promise<void> {
    const extraIds = req.params.extraIds.split(",");
